...
if __name__ == '__main__':
    ...
    for fn in filenames:
        ...
        im = transform(im)
        im2 = vgg_normalize(im) if args.use_vgg else im * 2 -1 #vgg_normalize
        img2.append(im)
        img.append(im2)
    img = torch.stack(img)
    img2 = torch.stack(img2)
    save_image(img2, os.path.join(args.output_root, 'original.jpg'))
    #img = img if args.use_vgg else img * 2 - 1
    ...
    for i, txt in enumerate(texts):
        ...
        out_filename = 'output22_%d.jpg' % i
